...
class TextCollection:
    def __init__(self, documents_list=[]):
        if documents_list:
            self.corpus = PlaintextCorpusReader(corpusdir, documents_list, word_tokenizer=preprocess)
...
def main():
    ...
    while True:
        ...
        document_list = search_word_in_vector(text_collection, query)
        text_collection = TextCollection(documents_list=document_list)
